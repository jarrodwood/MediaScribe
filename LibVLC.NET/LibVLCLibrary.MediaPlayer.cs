...
namespace LibVLC.NET
{
  ...
  partial class LibVLCLibrary
  {
    ...
    */
    ...
    //==========================================================================
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void libvlc_video_set_callbacks_signature(IntPtr mp, libvlc_video_lock_cb _lock, libvlc_video_unlock_cb unlock, libvlc_video_display_cb display, IntPtr opaque);
    ...
    public void libvlc_video_set_callbacks(IntPtr mp, libvlc_video_lock_cb _lock, libvlc_video_unlock_cb unlock, libvlc_video_display_cb display)
    {
      ...
      m_libvlc_video_set_callbacks(mp, _lock, unlock, display, mp);
    }
